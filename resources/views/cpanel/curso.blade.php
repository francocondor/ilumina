        ...
        <div class="box box-success">
            ...
            <form method="POST" id="FormCurso" novalidate enctype="multipart/form-data">
              <div class="box-body">
                  ...
                  <label for="Nombre">Numero de modulos</label>
                  <input class="form-control " id="Modulo" name="Modulo" type="text" placeholder="Numero de modulo">
                  <br>
                  ...
                  <select class="form-control" name="idInstructor" id="idInstructor">
                      ...
                      <?php foreach ($instructores as $instructor=>$i) {?>
                  ...
                  <select class="form-control" name="idCategoria" id="idCategoria">
                      ...
                      <?php }?>
                  </select><button type="button" class="btn btn-info btn-md" data-toggle="modal" data-target="#myModal">Añadir Nuevo</button-->
                  <br>

...
<td style="text-align:center;vertical-align:top;direction:ltr;font-size:0px;padding:40px 0px;"><!--[if mso | IE]>
      ...
      <![endif]--><div ><img src="https://i.imgur.com/35Lxz1q.jpg" width="100%" alt="">
...
`
  <h2 style="font-family: Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-weight: 500;font-size: 20px;color: #4F545C;letter-spacing: 0.27px;">Hola, 
  {{ $nombreAlumno ?? '' }}</h2>
<p>Hemos terminado de procesar tu compra.</p>
<p> Ahora podras acceder al curso de {{$cursoPedido ?? ''}}</p>
<p>[Pedido #{{ $ordenPedido ?? '' }}] con fecha {{ $fechaOrdenPedido ?? '' }} 

</p>

          </div></td></tr><tr><td style="word-break:break-word;font-size:0px;padding:10px 25px;" align="center"><table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:separate;" align="center" border="0"><tbody><tr><td style="border:none;border-radius:3px;color:white;cursor:auto;padding:15px 19px;background-color: #08b0c5;" align="center" valign="middle" bgcolor="#A62222">
<!--  TODO URL toevoegen -->
  <a href="http://iluminaarquitectura.com/" style="text-decoration:none;line-height:100%;color:white;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:15px;font-weight:normal;text-transform:none;margin:0px;" target="_blank">
Comenzar el curso
      ...
      <div style="cursor:auto;color:#3B5998;font-family:Whitney, Helvetica Neue, Helvetica, Arial, Lucida Grande, sans-serif;font-size:18px;font-weight:bold;line-height:16px;text-align:center;">
      <div style="padding: 20px 0px 0px 0px;">
            <a href="https://www.facebook.com/iluminaarquitectura/"><img src="https://img.icons8.com/android/24/000000/facebook.png" style="
    padding: 4px;
"></a>
            <a href="https://www.instagram.com/ilumina_arquitectura/"><img src="https://img.icons8.com/material-rounded/32/000000/instagram-new.png" style="
    padding: 0px;
"></a>
            <a href="https://www.youtube.com/channel/UCjrjECBNoRk3cu2XdTJhr8A"><img src="https://img.icons8.com/ios-glyphs/32/000000/youtube-play.png" style="
    padding: 0px;
"></a>
        </div>
